...
# Find a geojson file with a specific suffix in a directory
...
# Split data spatially into train/val/test using DBSCAN clustering
def spatial_split(patches, labels, positive_centers, negative_centers, num_s2_bands=12, seed=7):
    ...
    # Split clusters into train, val, and test sets
...
# Plot training history for loss, precision, recall, and AUC
...
def main(input_dir, output_dir, experiment_name):
    ...
    # Filter invalid geometries and apply mask
