#!/bin/bash
#SBATCH --job-name=asgm_train_with_osm_random_neg
...
# === Paths ===
INPUT_DIR=$HOME/mining_detector/256_with_osm_random_negatives
OUTPUT_DIR=$HOME/mining_detector/model_256_with_osm_random_negatives_ci
